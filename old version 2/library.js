...
function displayLibraryBooks() {
    ...
    myLibrary.forEach(item =>{
        ...
        bookElement.append(bookAuth);
        bookElement.append(bookTitle);
        bookElement.append(bookPages);
        bookElement.append(bookRead);
        bookElement.append(btnDelete);
        bookElement.append(linebreak);
        bookElement.append(bookStatus)
        bookElement.append(labelYes);
        bookElement.append(radioYes);
        bookElement.append(labelNo);
        bookElement.append(radioNo);
